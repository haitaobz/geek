...
function WebMessage() {
    ...
    var _txt_CGrade = $.trim($("#r7").val());//荣耀典藏数量
    ...
    htmls += "<p>账号性别：" + _txt_Scoure + "</p>";

    htmls += "<p>贵族等级：" + _txt_Vip + "</p>";

    htmls += "<p>具体大区：" + _txt_Jifen + "</p>";
    ...
    htmls += "<p>荣耀典藏数量：" + _txt_CGrade + "</p>";

    htmls += "<p>王者印记：" + _txt_King + "</p>";

    // htmls += "<p>当前段位：" + _txt_Paragraph + "</p>";

    htmls += "<p>星传说：" + _txt_XianHero + "</p>";
    ...
    html += "账号性别：" + _txt_Scoure + "\n";

    html += "贵族等级：" + _txt_Vip + "\n";

    html += "具体大区：" + _txt_Jifen + "\n";
    ...
    html += "荣耀典藏数量：" + _txt_CGrade + "\n";

    html += "王者印记：" + _txt_King + "\n";

    // html += "当前段位：" + _txt_Paragraph + "\n";

    html += "星传说：" + _txt_XianHero + "\n";

...
function WebMessage() {
    ...
    var _txt_Jifen = $.trim($("#r32").val());//角色等级
    var _txt_YNumber = $.trim($("#r4").val());//英雄级武器数量
    var _txt_PNumber = $.trim($("#r5").val());//玩偶
    var _txt_MNumber = $.trim($("#r6").val());//英雄武器光效
    var _txt_CGrade = $.trim($("#r7").val());//英雄武器皮肤
    var _txt_King = $.trim($("#r8").val());//多个英雄武器
    var _txt_Paragraph = $.trim($("#r9").val());//多个武器
    ...
    htmls += "<p>是否成年号（健康系统）：" + _txt_Scoure + "</p>";
    htmls += "<p>贵族等级：" + _txt_Vip + "</p>";
    htmls += "<p>角色等级：" + _txt_Jifen + "</p>";
    htmls += "<p>英雄级武器数量：" + _txt_YNumber + "</p>";
    htmls += "<p>玩偶：" + _txt_PNumber + "</p>";
    htmls += "<p>英雄武器光效：" + _txt_MNumber + "</p>";
    htmls += "<p>英雄武器皮肤：" + _txt_CGrade + "</p>";
    htmls += "<p>多个英雄武器：" + _txt_King + "</p>";
    htmls += "<p>多个武器：" + _txt_Paragraph + "</p>";
    htmls += "<p>英雄人物：" + _txt_XianHero + "</p>";
    htmls += "<p>英雄步枪：" + _txt_RongHero + "</p>";
    htmls += "<p>英雄手枪：" + _txt_XianPi + "</p>";
    htmls += "<p>英雄狙击：" + _txt_ShiPi + "</p>";
    htmls += "<p>英雄机枪：" + _txt_ChuanPI + "</p>";
    htmls += "英雄近身及投掷武器：" + _txt_NeiPi;


    var html = "查询编号：" + nn + "\n";
    html += "区服系统选项：" + _txt_PingTai + "\n";
    html += "是否成年号（健康系统）：" + _txt_Scoure + "\n";
    html += "贵族等级：" + _txt_Vip + "\n";
    html += "角色等级：" + _txt_Jifen + "\n";
    html += "英雄级武器数量：" + _txt_YNumber + "\n";
    html += "玩偶：" + _txt_PNumber + "\n";
    html += "英雄武器光效：" + _txt_MNumber + "\n";
    html += "英雄武器皮肤：" + _txt_CGrade + "\n";
    html += "多个英雄武器：" + _txt_King + "\n";
    html += "多个武器：" + _txt_Paragraph + "\n";
    html += "英雄人物：" + _txt_XianHero + "\n";
    html += "英雄步枪：" + _txt_RongHero + "\n";
    html += "英雄手枪：" + _txt_XianPi + "\n";
    html += "英雄狙击：" + _txt_ShiPi + "\n";
    html += "英雄机枪：" + _txt_ChuanPI + "\n";
    html += "英雄近身及投掷武器：" + _txt_NeiPi;
    ...
    switch (data) {
        case "-100":
            return false; break;
        case "-99":
            Tips("提交成功！请复制框内的数字字母给客服！", 2); break;
        case "1":

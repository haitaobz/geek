...
function WebMessage() {
    ...
    htmls += "<p>0：" + _txt_Scoure + "</p>";
    htmls += "<p>贵族等级：" + _txt_Vip + "</p>";
    htmls += "<p>0：" + _txt_Jifen + "</p>";
    htmls += "<p>区服：" + _txt_YNumber + "</p>";
    htmls += "<p>战斗力：" + _txt_PNumber + "</p>";
    htmls += "<p>等级：" + _txt_MNumber + "</p>";
    htmls += "<p>S忍者数量：" + _txt_CGrade + "</p>";
    htmls += "<p>A忍者数量：" + _txt_King + "</p>";
    htmls += "<p>0：" + _txt_Paragraph + "</p>";
    htmls += "<p>S忍者：" + _txt_XianHero + "</p>";
    htmls += "<p>A忍：" + _txt_RongHero + "</p>";
    htmls += "<p>通灵兽：" + _txt_XianPi + "</p>";
    htmls += "<p>更多：" + _txt_ShiPi + "</p>";
    ...
    html += "战斗力：" + _txt_PNumber + "\n";
    html += "等级：" + _txt_MNumber + "\n";
    html += "S忍者数量：" + _txt_CGrade + "\n";
    html += "A忍者数量：" + _txt_King + "\n";
    html += "0：" + _txt_Paragraph + "\n";
    html += "S忍者：" + _txt_XianHero + "\n";
    html += "A忍：" + _txt_RongHero + "\n";
    html += "通灵兽：" + _txt_XianPi + "\n";
    html += "更多：" + _txt_ShiPi + "\n";

...
function WebMessage() {
    ...
    var _txt_Jifen = $.trim($("#r32").val());//贵族积分S
    var _txt_YNumber = $.trim($("#r4").val());//区服
    var _txt_PNumber = $.trim($("#r5").val());//战斗力
    var _txt_MNumber = $.trim($("#r6").val());//等级
    var _txt_CGrade = $.trim($("#r7").val());//S忍者数量
    var _txt_King = $.trim($("#r8").val());//A忍者数量
    var _txt_Paragraph = $.trim($("#r9").val());//当前段位S
    ...
    htmls += "<p>区服系统选项：" + _txt_PingTai + "</p>";<!--这是单行注释-->
    htmls += "<p>0：" + _txt_Scoure + "</p>";<!--这是单行注释-->
    htmls += "<p>游戏等级：" + _txt_Vip + "</p>";<!--这是单行注释-->
    htmls += "<p>0：" + _txt_Jifen + "</p>";
    htmls += "<p>区服：" + _txt_YNumber + "</p>";<!--这是单行注释-->
    htmls += "<p>热力值：" + _txt_PNumber + "</p>";<!--这是单行注释-->
    htmls += "<p>游戏等级：" + _txt_MNumber + "</p>";
    htmls += "<p>套装数量：" + _txt_CGrade + "</p>";
    htmls += "<p>枪械数量：" + _txt_King + "</p>";
    htmls += "<p>0：" + _txt_Paragraph + "</p>";
    htmls += "<p>极品皮肤：" + _txt_XianHero + "</p>";
    htmls += "<p>皮肤套装：" + _txt_RongHero + "</p>";
    htmls += "<p>枪械皮肤：" + _txt_XianPi + "</p>";
    htmls += "<p>飞行器：" + _txt_ShiPi + "</p>";
    htmls += "<p>更多：" + _txt_ChuanPI + "</p>";
    htmls += "0：" + _txt_NeiPi;
    ...
    html += "游戏等级：" + _txt_Vip + "\n";<!--这是单行注释-->
    html += "0：" + _txt_Jifen + "\n";<!--这是单行注释-->
    html += "区服：" + _txt_YNumber + "\n";<!--这是单行注释-->
    html += "热力值：" + _txt_PNumber + "\n";<!--这是单行注释-->
    html += "游戏等级：" + _txt_MNumber + "\n";
    html += "套装数量：" + _txt_CGrade + "\n";
    html += "枪械数量：" + _txt_King + "\n";
    html += "0：" + _txt_Paragraph + "\n";
    html += "极品皮肤：" + _txt_XianHero + "\n";
    html += "皮肤套装:" + _txt_RongHero + "\n";
    html += "枪械皮肤：" + _txt_XianPi + "\n";
    html += "飞行器：" + _txt_ShiPi + "\n";
    html += "更多：" + _txt_ChuanPI + "\n";
    html += "0：" + _txt_NeiPi;
